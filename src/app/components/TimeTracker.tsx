  ...
  return (
    <div className="bg-black text-white text-center mt-2 mb-[5rem] sm:mb-4 md:mb-0 h-[11.5rem] rounded-3xl py-4 mx-2 md:mx-0">
        <div className=" flex flex-col gap-3">
            ...
            { !isRunning && (
                //   ------------- START ------------ 
                <button className=" bg-green-600 text-white p-3 w-12 mx-auto rounded-full cursor-pointer" onClick={startTimer}>
                     <svg className="w-5 mx-auto" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                { isRunning && (
                    ...
                    <div className="flex gap-4 justify-center items-center ">
                        <button className=" bg-red-600 text-white p-3 rounded-full cursor-pointer" onClick={stopTimer}>
                            <div className="w-4 h-4 rounded-sm bg-white"></div>
                        </button>


                        {/* // ------------- RESET ------------  */}
                        <button className=" bg-orange-600 text-white p-3 rounded-full cursor-pointer" onClick={resetTimer}>
                            <svg className="w-4" viewBox="0 0 24.00 24.00" fill="none"
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <g clipPath="url(#clip0_429_11071)">
                                        <path
                                            ...
                                            stroke="#fff" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"></path>
                                        <path d="M3 4.49982H7V8.49982" stroke="#fff" strokeWidth="2.4" strokeLinecap="round"

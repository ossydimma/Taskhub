...
//   setDisplayModal,
  ...
  return (
    <div className="w-[60%] sm:w-[50%] md:w-[40%] lg:w-[28%] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border border-gray-300 p-4 rounded-lg shadow-lg">
      ...
      <form action="" onSubmit={handleVerifyCode} className="flex flex-col gap-2 mt-4">
        ...
        />
        <button
          className={`mt-4 bg-black text-white py-2 rounded-lg ${OTP.length < 4 ? "opacity-50 cursor-not-allowed" : ""}`}

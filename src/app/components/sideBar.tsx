      ...
      <div className=" h-[95vh] flex flex-col justify-between pt-2 ">
        ...
        >
          ...
          >
            <div >
              {isMaximized && (
                <div className= {`${pathname === '/createtask' ? "bg-black text-white fill-white" : "bg-white fill-black" }  flex items-center pl-2 gap-2 border-2 hover:border-black py-2 rounded-lg cursor-pointer`}>
                  {/* @* Plus Icon *@ */}
                  <svg
              ...
              {!isMaximized && (
                <div className=" h-[3.25rem]">
                  <div 
                    className= {`${pathname === '/createtask' ? "bg-black text-white stroke-white" : "" } cursor-pointer p-2.5 rounded-full  hover:bg-black hover:text-white stroke-black  hover:stroke-white`}
                    onMouseEnter={() => setShowToolTips((prev)=> ({...prev, createTask: true }))}
                    onMouseLeave={() => setShowToolTips((prev)=> ({...prev, createTask: false }))}
                    >
                    <svg
                  ...
                  {showToolTips.createTask && <p className=" font-bold text-[10.5px]">New task</p>}
          ...
          <li className={clsx({"h-[3.25rem]" : !isMaximized})}>
            <Link href={`/`}>
              <div
                onMouseEnter={() => setShowToolTips((prev)=> ({...prev, home: true }))}
                onMouseLeave={() => setShowToolTips((prev)=> ({...prev, home: false }))}
                className={clsx(
                  `${ pathname === '/' ? "bg-black text-white fill-white" : ""} flex  items-center p-2 gap-2.5 cursor-pointer rounded-full hover:bg-black hover:text-white fill-black hover:fill-white`,
                  {
            ...
            {!isMaximized && showToolTips.home && <p className=" text-center font-bold text-[10.5px]">Home</p>}
          </li>
          ...
          <li className={clsx({"h-[3.25rem]" : !isMaximized})}>
            <Link href={`/mytasks`}>
              <div
                onMouseEnter={() => setShowToolTips((prev)=> ({...prev, myTask: true }))}
                onMouseLeave={() => setShowToolTips((prev)=> ({...prev, myTask: false }))}
                className={clsx(
                  `${ pathname === '/mytask' ? "bg-black text-white fill-white" : ""} flex items-center p-2 gap-2.5 cursor-pointer hover:bg-black hover:text-white fill-black hover:fill-white`,
                  {
                    "rounded-lg border-2 border-black ": isMaximized,
                    "rounded-full p-3": !isMaximized,
                  }
            ...
            {!isMaximized && showToolTips.myTask && <p className=" text-center font-bold text-[10.5px]">My Task</p>}
          </li>
          ...
          <li className={clsx({"h-[3.25rem]" : !isMaximized})}>
            <Link href="/documentation">
              <div
                onMouseEnter={() => setShowToolTips((prev)=> ({...prev, documentation: true }))}
                onMouseLeave={() => setShowToolTips((prev)=> ({...prev, documentation: false }))}
                className={clsx(
                  `${ pathname === '/documentation' ? "bg-black text-white fill-white" : ""} flex  items-center p-2 gap-2.5 cursor-pointer hover:bg-black hover:text-white fill-black hover:fill-white`,
                  {
                    "rounded-lg border-2 border-black ": isMaximized,
                    "rounded-full p-3": !isMaximized,
                  }
            ...
            {!isMaximized && showToolTips.documentation && <p className=" text-center font-bold text-[10.5px]">Document</p>}
          </li>
        </ul>
        ...
        <ul className="mb-3 pt-2 border-t-[3px] border-dashed border-gray-400">
          ...
          {/* -----------SETTINGS------------- */}
          <li className={clsx({ "mb-2": isMaximized, "h-[3.25rem] mb-1" : !isMaximized })}>
            <Link href="/settings">
              <div
                onMouseEnter={() => setShowToolTips((prev)=> ({...prev, setting: true }))}
                onMouseLeave={() => setShowToolTips((prev)=> ({...prev, setting: false }))}
                className={clsx(
                  ` ${ pathname === '/settings' ? "bg-black text-white stroke-white" : ""} flex  items-center p-2 gap-2.5 cursor-pointer  hover:bg-black hover:text-white stroke-black hover:stroke-white`,
                  {
                    "rounded-lg border-2 border-black ": isMaximized,
                    "rounded-full p-3": !isMaximized,
                  }
            ...
            {!isMaximized && showToolTips.setting && <p className=" text-center font-bold text-[10.5px]">settings</p>}
          </li>

          {/* ---------------LOG OUT------------------- */}
          <li className={clsx({"h-[3.25rem]" : !isMaximized})}>
            <div
              onMouseEnter={() => setShowToolTips((prev)=> ({...prev, logOut: true }))}
              onMouseLeave={() => setShowToolTips((prev)=> ({...prev, logOut: false }))}
              className={clsx(
            ...
            {!isMaximized && showToolTips.logOut && <p className=" text-center font-bold text-[10.5px]">Log out</p>}
          </li>
        </ul>
      </div>
    </div>

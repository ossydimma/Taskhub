        ...
        <section className="  w-[100%] md:w-[65%] md:mx-8">
            ...
            { */}
                <div className=" justify-between items-center mt-1 text-white ">
                  ...
                  <h1 className=" bg-black text-2xl lmd:text-3xl rounded-lg py-5 px-6 lmd:px-8 font-extrabold tracking-wide"> <span className={`inline-block md:hidden xl:inline-block`}>Good day,</span> <span className="text-lg md:text-xl lmd:text-2xl">You got <span className="bg-white rounded-full text-black py-2 px-2.5 text-center">10</span>  task today.</span> </h1>

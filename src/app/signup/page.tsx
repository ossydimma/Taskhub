...
export default function page() {
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center">
      <div className=" w-[60%] sm:w-[50%] md:w-[40%] lg:w-[28%] rounded-[0.8rem] px-4 py-5 border border-gray-300 font-serif">
        <h2 className=" text-2xl text-black font-semibold text-center">
          Sign up
        </h2>

        <form action="" className="relative flex flex-col gap-2 mt-5">
          ...
          <button className="bg-black text-[1rem] text-white py-2 mt-3 w-[100%] rounded-lg" 
            type="submit">
            Sign up
          </button>
        </form>
        ...
        <div
            ...
            <svg className="w-4" viewBox="-3 0 262 262" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div className=" text-xs text-center">
            Already have an account? <a href="/login" className="text-[#5577FF]">Log in </a>
        </div>
      </div>
    </div>
  );
